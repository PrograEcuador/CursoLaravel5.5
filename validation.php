...
return [
    ...
    */
    ...
    ' different '             =>  ' Los campos: atributo y: otros han de ser diferentes. ' ,
    ...
    ' email '                 =>  ' El campo: atributo no corresponde con una dirección de correo electrónico válida. ' ,
    ' file '                  =>  ' El campo: atributo debe ser un archivo. ' ,
    ' filled '                =>  ' El campo: attribute es obligatorio. ' ,
    ' exists '                =>  ' El campo: atributo no existe. ' ,
    ' imagen '                 =>  ' El campo: atributo debe ser una imagen. ' ,
    ' in '                    =>  ' El campo: atributo debe ser igual a alguno de estos valores: valores. ' ,
    ...
    ' max '                   => [
        ' numeric '  =>  ' El campo: atributo debe ser: max como máximo. ' ,
        ' file '     =>  ' El archivo: atributo debe pesar: max kilobytes como máximo. ' ,
        ' string '   =>  ' El campo: atributo debe contener: max caracteres como máximo. ' ,
        ' array '    =>  ' El campo: attribute should contener: max elementos como máximo. ' ,
    ],
    ...
    ' min '                   => [
        ...
        ' array '    =>  ' El campo: atributo no debe contener más de: elementos mínimos. ' ,
    ],
    ...
    ' cadena '                =>  ' El campo: atributo debe contener sólo caracteres. ' ,
    ' timezone '              =>  ' El campo: attribute debe contener una zona válida. ' ,
    ' unique '                =>  ' El elemento: attribute ya está en uso. ' ,
    ' cargado '              =>  ' El elemento: atributo obtenido al subir. ' ,
    ' url '                   =>  ' El formato de: atributo no corresponde con el de una URL válida. ' ,
    /*
    | ------------------------------------------------- -------------------------
